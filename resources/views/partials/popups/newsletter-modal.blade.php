      ...
      <div class="wow-newsletter-content" id="wow-newsletter-content">
        ...
        <div class="wow-newsletter-default"><div class="wow-newsletter-main">
          ...
          <form class="wow-newsletter-form" id="wow-newsletter-form" data-subscriber-form="newsletter-modal" data-subscriber-source="Popup update" novalidate>
            <div class="wow-newsletter-input-wrap"><svg class="wow-newsletter-input-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true"><circle cx="12" cy="8" r="3.2" stroke="currentColor" stroke-width="1.7"/><path d="M5.5 20c.7-3.1 3.1-5 6.5-5s5.8 1.9 6.5 5" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"/></svg><input class="wow-newsletter-input" id="wow-newsletter-first-name" name="first_name" type="text" autocomplete="given-name" placeholder="First name" aria-label="First name" maxlength="80" required></div>
