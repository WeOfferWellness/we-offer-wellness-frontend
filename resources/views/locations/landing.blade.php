...
@push('head')
  ...
  <style>
    ...
    @media(max-width:599.98px){.location-landing__grid{grid-template-columns:repeat(2,minmax(0,1fr))}.location-landing__tiles,.location-landing__directory ul{grid-template-columns:repeat(2,minmax(0,1fr))}}
    @media(min-width:600px) and (max-width:767.98px){.location-landing__grid{grid-template-columns:repeat(2,minmax(0,1fr));gap:16px}}
    @media(min-width:600px) and (max-width:767.98px) and (orientation:landscape){.location-landing__grid{grid-template-columns:repeat(3,minmax(0,1fr));gap:16px}}
