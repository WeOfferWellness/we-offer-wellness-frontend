    ...
    private function renderTypeLanding(Request $request, string $type)
    {
        $config = match ($type) {
            'therapies' => [
                ...
                'points' => [],
                'hero_aside' => ['label' => 'A useful starting point', 'title' => 'Find support that fits', 'text' => 'Explore relevant therapies, classes and experiences without the noise.'],
            ...
            'events' => [
                ...
                'hero_aside' => ['label' => 'A useful starting point', 'title' => 'Find an event that fits', 'text' => 'Explore relevant events and experiences without the noise.'],
            ...
            'workshops' => [
                ...
                'hero_aside' => ['label' => 'A useful starting point', 'title' => 'Find a workshop that fits', 'text' => 'Explore relevant workshops and guided experiences without the noise.'],
            ...
            'classes' => [
                ...
                'hero_aside' => ['label' => 'A useful starting point', 'title' => 'Find a class that fits', 'text' => 'Explore relevant classes and supportive sessions without the noise.'],
            ...
            'retreats' => [
                ...
                'hero_aside' => ['label' => 'A useful starting point', 'title' => 'Find a retreat that fits', 'text' => 'Explore relevant retreats and restorative experiences without the noise.'],
